...
struct KnotVector{K <: AbstractVector{<:Number}, M <: AbstractVector{<: Integer}}
    ...
    function KnotVector(knot_values, multiplicities)
        ...
        new{typeof(knot_values), typeof(multiplicities)}(knot_values, multiplicities, knots_all)
    end
end
...
"""
function KnotVector(n_basis_functions::Integer, degree::Integer; extent::Tuple{Number, Number} = (0,1), distribution::Symbol = :equispaced)::KnotVector
