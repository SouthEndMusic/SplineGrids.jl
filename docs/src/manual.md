...
refine(::SplineGrids.AbstractSplineGrid{Nin, Nout, false, Tv, Ti}, ::SplineGrids.AbstractSplineDimension{Tv, Ti}, ::Integer, ::SplineGrids.AbstractRefinementMatrix{Tv, Ti}) where {Nin, Nout, Tv, Ti}
```
